            ...
            <div className="tab-content ">
              <div className="row x-gap-20 y-gap-20">
                ...
                <div className="col-12">
                  ...
                  <div className="col-12">
                    <div className="fw-bold mb-3">Car Image</div>
                  ...
                  <div className="col-12">
                    <div className="fw-bold mb-3">Car Gallery Images</div>
                    <div class="upload-container">
                      <label for="bannerUpload" class="upload-box">
                        <div class="upload-content">
                          <i class="bi bi-upload upload-icon"></i>
                            ...
                            <td>
                              <div className="form-floating">
                                <input
                                  ...
                                  required
                                />
                                <label>Eg: Which car is most suitable?</label>
                              </div>
                            </td>
                            <td>
                              <div className="form-floating">
              ...
              <div className="row">
                ...
                <div class="col">
                  <input
                    type="text"
                    class="form-control mh-70"
                    placeholder="Map Longtitude"
                    aria-label="Map Longtitude"
                  />
                </div>
                <div class="col">
                  <input
            ...
            <div className="tab-content">
              <div className=" row">
                <div className=" mt-30 d-flex flex-column">
                  <div className="fw-500 mb-2">Car Type</div>
                ...
                <div className=" mt-30 d-flex flex-column">
                  <div className="fw-500 mb-2">Car Model</div>
                  <div className="d-flex flex-row">
                    <div className="property-type__content  scroll-bar-1 col">
                      <div className="property-type__column">
                        <div className="property-type__item">
