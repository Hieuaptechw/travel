...
const Header = () => {
    ...
    return (
        <header className="header-main p-3 sticky-top" onPointerLeave={handleHeaderMouseExit}>
            ...
            <section id="nav-explore" className={
                ...
                <Container>
                    <div class="row align-items-stretch">
                        ...
                        <div className="col-9 row gx-2">
                            <div className="col-4">
                                <Link className="card text-decoration-none" to="/tours">
                            ...
                            <div className="col-4">
                                <Link className="card text-decoration-none" to="/locations">
                                    <img className="card-img-top" src="//placehold.co/400x240" />
                                    <div class="card-body">
            ...
            <section id="nav-stay" className={
                ...
                <Container>
                    <div class="row align-items-stretch">
                        ...
                        <div className="col-9 row gx-2">
                            <div className="col-4">
                                <Link className="card text-decoration-none" to="/hotels">
                                    <img className="card-img-top" src="//placehold.co/400x240" />
                                    <div class="card-body">
                            ...
                            <div className="col-4">
                                <Link className="card text-decoration-none" to="/rentals">
                                    <img className="card-img-top" src="//placehold.co/400x240" />
                                    <div class="card-body">
                            ...
                            <div className="col-4">
                                <Link className="card text-decoration-none" to="/cruises">
                                    <img className="card-img-top" src="//placehold.co/400x240" />
                                    <div class="card-body">
            ...
            <section id="nav-transport" className={
                ...
                <Container>
                    <div class="row align-items-stretch">
                        ...
                        <div className="col-9 row gx-2">
                            <div className="col-4">
                                <Link className="card text-decoration-none" to="/flights">
                                    <img className="card-img-top" src="//placehold.co/400x240" />
                                    <div class="card-body">
                            ...
                            <div className="col-4">
                                <Link className="card text-decoration-none" to="/trains">
                                    <img className="card-img-top" src="//placehold.co/400x240" />
                                    <div class="card-body">
                            ...
                            <div className="col-4">
                                <Link className="card text-decoration-none" to="/cars">
                                    <img className="card-img-top" src="//placehold.co/400x240" />
                                    <div class="card-body">
