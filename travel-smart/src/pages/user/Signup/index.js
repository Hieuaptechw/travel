                    ...
                    <Col md={8} lg={6}>
                        <Form className="login-form">
                            ...
                            <div className="social-buttons d-flex justify-content-center mt-3">
                                <Button className="social-btn facebook-btn me-2" variant="outline-primary" type="button">
                            ...
                            <div className='sub-1 text-center mt-4'>
                                <span>By creating an account, you agree to our Terms of Service and Privacy Statement.</span>
                            </div>
                        </Form>
                    </Col>
                </Row>
